...
OPTION_CHAIN_SELECTABLE_FEATURES: tuple[OptionChainSelectableFeature, ...] = (
    ...
    OptionChainSelectableFeature("quality_issue_count", "Quality issue count", "numeric", "Quality and Flags", 130),
    OptionChainSelectableFeature("dropped_liquidity", "Dropped liquidity", "numeric", "Quality and Flags", 140),
    OptionChainSelectableFeature("dropped_intrinsic", "Dropped intrinsic", "numeric", "Quality and Flags", 150),
    OptionChainSelectableFeature("dropped_insane", "Dropped insane", "numeric", "Quality and Flags", 160),
    OptionChainSelectableFeature(
        "prn_monotone_adj_intervals",
        "pRN monotone adj intervals",
        "numeric",
        "Quality and Flags",
        170,
    ),
